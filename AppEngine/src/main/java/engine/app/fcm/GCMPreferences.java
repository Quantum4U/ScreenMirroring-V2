...
public class GCMPreferences {
    ...
    public boolean getNavigateDashboardPage() {
        return preferences.getBoolean("Navigation_Dashboard", false);
    }

    public void setNavigateDashboardPage(boolean flag) {
        editor.putBoolean("Navigation_Dashboard", flag);
        editor.commit();
    }

    public void setPhoneUsageTimer(int position) {
        editor.putInt("phone_usage_timer", position);
        editor.commit();
    }

    public int getPhoneUsageTimer() {
        return preferences.getInt("phone_usage_timer", 2);
    }

    public long getLastAppUseNotifiTime() {
        return preferences.getLong("LastAppUseNotifiTime", 0);
    }

    public void setLastAppUseNotifiTime(long value) {
        editor.putLong("LastAppUseNotifiTime", value);
        editor.commit();
    }
    ...
    public boolean getWifiEnable() {
        return preferences.getBoolean("WIFI_ENABLE", false);
    }

    public void setWifiEnable(boolean flag) {
        editor.putBoolean("WIFI_ENABLE", flag);
        editor.commit();
    }

    //FOR RAM_ACTIVITY
    public long getLastRamExitTime() {
        return preferences.getLong("_exit_ram_Time_", 0);
    }

    public void setLastRamTimeStamp(long value) {
        editor.putLong("_exit_ram_Time_", value);
        editor.commit();
    }

    public void setLanguage(boolean flag) {
        editor.putBoolean("lang_pref", flag);
        editor.commit();
    }

    public boolean isLanguage() {
        return preferences.getBoolean("lang_pref", false);
    }
    ...
    public String isDoNotShow() {
        return preferences.getString(KEY_DO_NOT_SHOW, "false");
    }
}