...
import static engine.app.serviceprovider.Utils.get_FulladsshownCount;
    ...
    public void getBannerAds(final Activity context, final AppAdsListener listener) {
      /*  PrintLog.print("call banner");
        ...
        *//*issue when we tring to load on onReceiveAd listener.*//*
        ...
        listener.onAdFailed(AdsEnum.ADS_STARTUP, "Not used");
    }

    private void showVideoAds(final AppFullAdsListener listener,boolean isFromSplash) {
       /* if (startAppAd.isReady()) {
            ...
            if(!isFromSplash) {
                loadFullAds(listener, false);
            }
        }*/

        listener.onFullAdFailed(AdsEnum.FULL_ADS_STARTUP, "Not used");
    }


    public void loadFullAds(final AppFullAdsListener listener, final boolean isFromCache) {
        ...
        startAppAd.setVideoListener(() -> Log.d("StartupAdsProvider", "Hello onVideoCompleted complted>>"));*/
       listener.onFullAdFailed(AdsEnum.FULL_ADS_STARTUP, "Not used");
    }

    public void showfullAds(final Activity activity, int Videoadscount, final AppFullAdsListener listener,boolean isFromSplash) {
        ...
        try {
            if (currentcount % Videoadscount == 0) {
                ...
                showVideoAds(listener,isFromSplash);
            } else {
        ...
        startAppNativeAd.loadAd(
                ...
                new AdEventListener() {
                    ...
                    public void onReceiveAd(Ad ad) {
                        ...
                        final LinearLayout adView = (LinearLayout) inflater.inflate(R.layout.ad_startup_native_medium,
        ...
        startAppNativeAd.loadAd(
                ...
                new AdEventListener() {
                    ...
                    public void onReceiveAd(Ad ad) {
                        PrintLog.print("0956 checking 01");
                        LayoutInflater inflater = LayoutInflater.from(context);
                        final LinearLayout adView = (LinearLayout) inflater.inflate(R.layout.ad_startup_native_large,
                        ...
                        // Verify that an ad was retrieved
                        if (nativeAd[0] != null) {
                            nativeAd[0].registerViewForInteraction(adView);
                            // When ad is received and displayed - we MUST send impression
...
//                            });
    ...
    public void showNativeMedium_Grid(final Context context, String adsID, final AppAdsListener listener) {
      /*  adsID = adsID.trim();
        ...
        startAppNativeAd.loadAd(
                ...
                new AdEventListener() {
                    ...
                    public void onReceiveAd(Ad ad) {
                        ...
                        LayoutInflater inflater = LayoutInflater.from(context);
                        final LinearLayout adView = (LinearLayout) inflater.inflate(R.layout.ad_startup_grid,
                                nativeAdContainer, false);
                        nativeAdContainer.addView(adView);
                        ArrayList<NativeAdDetails> nativeAdsList = startAppNativeAd.getNativeAds();
                        if (nativeAdsList.size() > 0) {
...
//                                }
//                            });
//                            final Button clickbutton = adView.findViewById(R.id.native_install);
